  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', gap: 0, height: '100%' }}>
          <button
        ...
        {panel === 'report' && csv && (
          <button className="run-btn" onClick={onRunAnalysis} disabled={isAnalyzing} style={{ fontSize: 11, padding: '5px 12px' }}>
            {isAnalyzing
